...
class questions(models.Model):
    classes = models.IntegerField(choices=CLASSSS_CHOICES, max_length=100, default=None, null=True)
    subject = models.CharField(choices=SUBJECT_CHOICES, max_length=100, default=None, null=True)
    chapter = models.IntegerField(choices=CHAPTERS_CHOICES, max_length=100, default=None, null=True)
