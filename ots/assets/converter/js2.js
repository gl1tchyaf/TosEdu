var ID="EDT2";var ConvertFrom="bijoy"
...
function ConvertFromTextArea2(idcvt)
...
{var field=document.getElementsByName('ConversionOption');var convertarea=document.getElementById('CONVERTEDT2');if(ConvertFrom=="bijoy")
...
myFld.style.width=400;var convertarea=document.getElementById('CONVERTEDT2');convertarea.style.width=400;}