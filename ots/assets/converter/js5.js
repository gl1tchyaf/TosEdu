var ID="EDT5";var ConvertFrom="bijoy"
...
function ConvertFromTextArea5(idcvt)
...
{var field=document.getElementsByName('ConversionOption');var convertarea=document.getElementById('CONVERTEDT5');if(ConvertFrom=="bijoy")
...
myFld.style.width=400;var convertarea=document.getElementById('CONVERTEDT5');convertarea.style.width=400;}