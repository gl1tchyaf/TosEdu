var ID="EDT3";var ConvertFrom="bijoy"
...
function ConvertFromTextArea3(idcvt)
...
{var field=document.getElementsByName('ConversionOption');var convertarea=document.getElementById('CONVERTEDT3');if(ConvertFrom=="bijoy")
...
myFld.style.width=400;var convertarea=document.getElementById('CONVERTEDT3');convertarea.style.width=400;}